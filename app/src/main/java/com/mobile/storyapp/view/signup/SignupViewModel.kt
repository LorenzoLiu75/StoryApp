        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.error == false) {
                    _registrationStatus.value = RegistrationStatus.Success(response.message ?: "User Created!")
                } else {
                    _registrationStatus.value = RegistrationStatus.Error(response.message ?: "Registration failed")
                }
